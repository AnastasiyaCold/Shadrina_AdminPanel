...
<div class="container">
    <form action="storear.php" method="post">
        <div class="form-group">
            <label for="name">Title article</label>
            <input type="text" id="namear" class="form-control" name="namear">
            <label for="name">Description</label>
            <input type="text" id="descriptionar" class="form-control" name="descriptionar">
        </div>
